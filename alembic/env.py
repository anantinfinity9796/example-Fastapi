...
# Importing the Base object from app.models file which would allow alembic to have access to all our models.
from app.models import Base

# importing the settings object from app.config file which will get our envirnment variables and pass it here.
...
target_metadata = Base.metadata # accessing the sqlalchemy Base objects metadata which would allow alembic to access all our models.
